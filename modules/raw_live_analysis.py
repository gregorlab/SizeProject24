## this script is mostly based on Judith Pineau's functions for the live movie analysis
## additionally functions are added and adapted combining the gene expression, morphological, and multipolarity analysis
...
from modules.processed_data_analysis import load_processed_df
...
# function deployed on gastrruloid mask after segmentation
...
# big function combining the live movie mask analysis
def compute_live_movie_mask_analysis(df, save_path, save=True):
    ...
    :param save_path: The file path where the updated data frame should be saved, if
                      saving is enabled.
    :type save_path: str
    :param save: A boolean flag indicating whether to save the updated data
...
#########################################
# functions for fluorescent movie analysis
...
# big function combining the multipolarity analysis
